...
http_response(struct soap *soap, int status, ULONG64 count)
{
  ...
  else if (status < 200 || status >= 600)
  {
    ...
    if (status >= SOAP_GET_METHOD && status <= SOAP_HTTP_METHOD)
      code = 405;
    else if (soap->version == 2 && (!s || !strcmp(s, "soap:Sender")))
      code = 400;
    else
      code = 500;
  }
...
soap_element(struct soap *soap, const char *tag, int id, const char *type)
{
  ...
  if (soap->mustUnderstand)
  {
    ...
    {
      if (soap_attribute(soap, soap->version == 2 ? "soap:role" : "soap:actor", soap->actor))
        return soap->error;
    }
    if (soap_attribute(soap, "soap:mustUnderstand", soap->version == 2 ? "true" : "1"))
      return soap->error;
    soap->mustUnderstand = 0;
  }
  if (soap->encoding)
  {
    if (soap->encodingStyle && soap->local_namespaces && soap->local_namespaces[0].id && soap->local_namespaces[1].id)
    {
      ...
      if (soap->encodingStyle && soap_attribute(soap, "soap:encodingStyle", soap->encodingStyle))
        return soap->error;
    }
    else
    {
  ...
  *s = '\0';
  ...
  for (tp = soap->attributes; tp; tp = tp->next)
  {
    if (tp->visible && tp->value)
    {
      ...
      else if (!soap_match_tag(soap, tp->name, "soap:encodingStyle"))
      {
        if (!soap->encodingStyle)
          soap->encodingStyle = SOAP_STR_EOS;
        soap_version(soap);
      ...
      else if (soap->version == 1)
      {
        ...
        else if (!soap_match_tag(soap, tp->name, "soap:mustUnderstand")
              && (!strcmp(tp->value, "1") || !strcmp(tp->value, "true")))
        {
          soap->mustUnderstand = 1;
        }
        else if (!soap_match_tag(soap, tp->name, "soap:actor"))
        {
      ...
      else if (soap->version == 2)
      {
        ...
        else if (!soap_match_tag(soap, tp->name, "soap:role"))
        {
          if ((!soap->actor || strcmp(soap->actor, tp->value))
...
soap_envelope_begin_out(struct soap *soap)
{
  ...
  return soap_element_begin_out(soap, "soap:Envelope", 0, NULL);
}
...
soap_envelope_end_out(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  if (soap_element_end_out(soap, "soap:Envelope")
   || soap_send_raw(soap, "\r\n", 2))   /* 2.8: always emit \r\n */
    return soap->error;
...
{
  soap->part = SOAP_IN_ENVELOPE;
  if (soap_element_begin_in(soap, "soap:Envelope", 0, NULL))
  {
...
soap_envelope_end_in(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  soap->part = SOAP_END_ENVELOPE;
  return soap_element_end_in(soap, "soap:Envelope");
}
...
soap_body_begin_out(struct soap *soap)
{
  ...
  return soap_element_begin_out(soap, "soap:Body", 0, NULL);
}
...
soap_body_end_out(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  if (soap_element_end_out(soap, "soap:Body"))
    return soap->error;
...
soap_body_begin_in(struct soap *soap)
{
  if (soap->version == 0)
    return SOAP_OK;
  soap->part = SOAP_IN_BODY;
  if (soap_element_begin_in(soap, "soap:Body", 0, NULL))
    return soap->error;
  if (!soap->body)
...
soap_body_end_in(struct soap *soap)
{
  ...
  if (soap->part == SOAP_NO_BODY)
    return soap->error = SOAP_OK;
  soap->part = SOAP_END_BODY;
  return soap_element_end_in(soap, "soap:Body");
}
...
soap_recv_fault(struct soap *soap, int check)
{
  ...
  if (soap_getfault(soap))
  {
    ...
    *soap_faultcode(soap) = (soap->version == 2 ? "soap:Sender" : "soap:Client");
    if (status)
      soap->error = status;
    else
  ...
  {
    const char *s = *soap_faultcode(soap);
    if (!soap_match_tag(soap, s, "soap:Server")
     || !soap_match_tag(soap, s, "soap:Receiver"))
    {
      status = SOAP_SVR_FAULT;
    }
    else if (!soap_match_tag(soap, s, "soap:Client")
          || !soap_match_tag(soap, s, "soap:Sender"))
    {
      status = SOAP_CLI_FAULT;
    }
    else if (!soap_match_tag(soap, s, "soap:MustUnderstand"))
    {
      status = SOAP_MUSTUNDERSTAND;
    }
    else if (!soap_match_tag(soap, s, "soap:VersionMismatch"))
    {
...
{
  return soap_set_error(soap, soap->version == 2 ? "soap:Sender" : soap->version == 1 ? "soap:Client" : "at sender", NULL, faultstring, faultdetailXML, soaperror);
}
...
{
  return soap_set_error(soap, soap->version == 2 ? "soap:Receiver" : soap->version == 1 ? "soap:Server" : "detected", NULL, faultstring, faultdetailXML, soaperror);
}
...
{
  return soap_copy_fault(soap, soap->version == 2 ? "soap:Sender" : soap->version == 1 ? "soap:Client" : "at source", faultsubcodeQName, faultstring, faultdetailXML);
}
...
{
  return soap_copy_fault(soap, soap->version == 2 ? "soap:Receiver" : soap->version == 1 ? "soap:Server" : "is internal", faultsubcodeQName, faultstring, faultdetailXML);
}
